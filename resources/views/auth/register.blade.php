...
<body class="flex flex-col min-h-screen bg-gradient-to-b from-green-50 to-white">
   ...
   <!-- Register Section -->
<section id="register" class="flex flex-col justify-center items-center flex-grow py-12 lg:py-5">
    <!-- Form Container -->
    <div
        ...
        <form class="w-full space-y-6 sm:space-y-8">
            ...
            <div class="text-center text-sm text-gray-600 mt-6 sm:mt-8 space-y-3">
                <p>Sudah punya akun? <a href="#" class="text-[#00A59F] font-medium hover:underline">Masuk di sini</a></p>
            </div>
        </form>
    </div>
</section>
